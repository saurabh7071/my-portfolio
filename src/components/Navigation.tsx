      ...
      >
        {SECTIONS.map((section) => {
          ...
          return (
            ...
            >
              <motion.span
                className="annotation pointer-events-none"
                initial={{ opacity: 0, x: 8 }}
                whileInView={{ opacity: 0 }}
                style={{
                  color: isActive ? "var(--copper)" : "var(--graphite)",
              ...
              <span
                className="annotation opacity-0 group-hover:opacity-100 transition-all duration-200 translate-x-2 group-hover:translate-x-0"
      ...
      <AnimatePresence>
        {menuOpen && (
          ...
          >
            ...
            <div className="flex-1 flex flex-col justify-center max-w-7xl mx-auto w-full px-6 lg:px-10 py-24">
              <motion.div
                    ...
                    >
                      ...
                      >
                        <div className="flex items-baseline gap-5 lg:gap-8">
                          ...
                          <span
                            className="display transition-colors duration-200 group-hover:text-copper"
                            style={{
                              fontSize: "clamp(1.75rem, 4.5vw, 4rem)",
                              color: isActive ? "var(--copper)" : "oklch(0.975 0.010 75)",
                              lineHeight: 1,
                            }}
                          >
                            {section.label}
            ...
            <motion.div
              ...
              style={{ borderColor: "oklch(0.975 0.010 75 / 0.07)" }}
            >
              <span className="annotation" style={{ color: "oklch(0.975 0.010 75)", opacity: 0.2 }}>
                Saurabh Vaidya — Full Stack Engineer
              </span>
              <span className="annotation" style={{ color: "oklch(0.975 0.010 75)", opacity: 0.2 }}>
                40.7128°N — 74.0060°W
              </span>
